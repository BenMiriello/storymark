...
import { StorymarkRenderer } from '../components/StorymarkRenderer';

describe('StorymarkRenderer Component', () => {
...
@fade: slow`;
  ...
  test('should display errors when parsing fails', () => {
    ...
    render(<StorymarkRenderer content={invalidContent} />);
...
@template: photo_essay`;
    ...
    const { container } = render(<StorymarkRenderer content={content} />);
